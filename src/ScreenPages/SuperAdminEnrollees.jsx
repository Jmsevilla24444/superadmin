      ...
      >
        ...
        <div className="ad-form-actions">
          <button
            className="ad-btn"
            type="button"
            onClick={() => (window.location.hash = "#/su/users")}
          >
            Back to Users
          </button>
        </div>
      ...
      <div className="ad-table-card" style={{ marginTop: 10 }}>
        <table className="ad-table">
          ...
          <tbody>
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={5} style={{ color: "#6b7280", padding: 18 }}>
                  No enrollees found.
                </td>
              </tr>
            )}
          ...
          <div style={{ display: "grid", gap: 12 }}>
            ...
            >
              ...
              <button
                ...
                type="button"
                onClick={() => setApproveConfirmId(viewing.id)}
              >
        ...
        >
          ...
          >
            ...
            <div style={{ padding: 16, color: "#374151" }}>
              Approve this enrollee and move them forward? This action cannot be
              undone.
            </div>
            <div
              className="ad-form-actions"
      ...
      {confirmId !== null && (
        ...
        >
          ...
          >
            ...
            <div style={{ padding: 16, color: "#374151" }}>
              Are you sure you want to delete this enrollee record? This action
              cannot be undone.
            </div>
            <div
              className="ad-form-actions"
